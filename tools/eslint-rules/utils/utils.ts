...
export function getIdentifierFromArrayExpression(node: TSESTree.ArrayExpression, parameterName: string): TSESTree.Identifier {
	const elements: TSESTree.Identifier[] = node.elements as TSESTree.Identifier[];

	return (elements as Array<TSESTree.Identifier>)
...
export function getAddImportRuleFix(specifier: string, source: string, program: TSESTree.Program, fixer) {
...
export function getDecoratorPropertyValueArrayExpression(node: TSESTree.Decorator, name: string): TSESTree.ArrayExpression {
	const property: TSESTree.Property = getDecoratorProperty(node, name);
	if (!property) {
		return undefined;
	}
...
export function getDecoratorProperty(node: TSESTree.Decorator, name: string): TSESTree.Property {
	...
	const properties: Array<any> = arg.properties;
